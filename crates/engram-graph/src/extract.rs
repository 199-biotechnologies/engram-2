...
const COMMON_WORDS: &[&str] = &[
    ...
    "Us", "If", "Then", "When", "While", "After", "Before",
    ...
    "See", "Show", "Shows", "Shown", "Find", "Found", "Take", "Takes",
    "Get", "Gets", "Make", "Makes", "Use", "Uses", "Used", "Note",
    "Consider", "Observe", "Assume", "Suppose", "Recall", "Remember",
    "Respond", "Responds", "Reply", "Replies", "Return", "Returns",
    "Let", "Given", "Set", "Put", "Apply", "Applied", "Call", "Called",
    // Logical / rhetorical connectives at sentence start
    "Thus", "Therefore", "Hence", "However", "Moreover", "Furthermore",
    "Additionally", "Nonetheless", "Nevertheless", "Indeed", "Instead",
    "Finally", "Accordingly", "Consequently", "Specifically", "Namely",
    "Otherwise", "Similarly", "Likewise", "Meanwhile", "Overall",
    // Paper structural words — typically in "Table 1", "Figure 2", etc.
    "Table", "Figure", "Fig", "Section", "Appendix", "Abstract",
    "Introduction", "Methods", "Results", "Discussion", "Conclusion",
    "References", "Acknowledgments", "Appendices", "Equation", "Eq",
